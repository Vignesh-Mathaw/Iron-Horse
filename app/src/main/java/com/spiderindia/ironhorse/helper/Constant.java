...
//    public static String MAINBASEUrl = "https://spiderekart.in/msvr/";
//    public static String MAINBASEUrl = "https://spiderekart.in/EU/";
    public static String MAINBASEUrl = "https://spiderekart.in/ironhorse/";
    ...
    public static String STORE_SETTING_URL = MAINBASEUrl + "getstorecondition.php";
    public static String LOYALTY_POINTS_URL = BaseUrl + "getloyaltypoints.php";
    ...
    public static String GETDELIVERYMETHOD_URL = MAINBASEUrl + "getdeliverymethod.php";

    public static String INSTAMOJO = BaseUrl + "instamojo.php";
    ...
    String AccessKey_retrofit = "accesskey";
    public static String AccessKeyVal = "90336";
    String AccessKeyVal_retrofit = "accesskey";
    ...
    public static String StoreOpenStatus = "store_open_status";
    public static String Points_Loyalty = "0";
    ...
    public static String ADDRESS_ID_DELIVERY= "address_id";
    ...
    public static String JWT_KEY = "HS256";
    ...
    public static boolean isOrderRating;
