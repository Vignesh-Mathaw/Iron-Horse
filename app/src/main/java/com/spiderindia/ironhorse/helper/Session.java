...
import com.spiderindia.ironhorse.activity.MainActivity;
...
public class Session {
    ...
    public static final String KEY_LATITUDE_MANAGE_ADDRESS = "manage_latitude";
    public static final String KEY_LONGITUDE_MANAGE_ADDRESS = "manage_longitude";
    ...
    public static final String KEY_DELIVERY_CITYID = "delivery_city_id";
    public static final String KEY_DELIVERY_AREAID = "delivery_area_id";
    public static final String KEY_DELIVERY_PINCODE = "delivery_pincode";
    public static final String KEY_DELIVERY_LAT = "delivery_lat";
    public static final String KEY_DELIVERY_LONG = "delivery_long";
    public static final String KEY_DELIVERY_MOBILE = "delivery_mobile";
    ...
    public void logoutUser_reset(Activity activity) {
        editor.clear();
        editor.commit();
