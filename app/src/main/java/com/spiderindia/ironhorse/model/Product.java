...
public class Product implements Serializable {
    ...
    public ArrayList<String> getOther_images_1() {
        return other_images_1;
    }

    public void setOther_images_1(ArrayList<String> other_images_1) {
        this.other_images_1 = other_images_1;
    }
    ...
    public Product(String brandname,String id, String name, String slug, String subcategory_id,
                   String image, String other_images, String description, String status, String date_added,
                   String category_id, ArrayList<PriceVariation> priceVariations, String indicator,String rating,String rating_count) {
        this.brandname = brandname;
        this.id = id;
        this.name = name;
        this.slug = slug;
    ...
    public Product(String brandname,String id, String name, String slug, String subcategory_id,
                   String image, String other_images, String description, String status, String date_added,
                   String category_id, ArrayList<PriceVariation> priceVariations, String indicator,String rating,String rating_count,String str) {
        this.brandname = brandname;
        this.id = id;
        this.name = name;
        this.slug = slug;
