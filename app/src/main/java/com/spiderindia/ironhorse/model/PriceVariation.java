...
public class PriceVariation implements Serializable {
    private String id, product_id, type, measurement,
            measurement_unit_id, productPrice, price,
            discounted_price, serve_for, stock, stock_unit_id,
            measurement_unit_name, stock_unit_name, discountpercent;
    private int qty;
    private double totalprice;



    public PriceVariation(String id, String product_id, String type, String measurement,
                          String measurement_unit_id, String productPrice, String price,
                          String discounted_price, String serve_for, String stock,
                          String stock_unit_id, String measurement_unit_name,
                          String stock_unit_name, String discountpercent) {
        this.id = id;
    ...
    public PriceVariation(String id, String product_id, String type, String measurement,
                          ...
                          String discounted_price, String serve_for, String stock,
                          String stock_unit_id, String measurement_unit_name,
                          String stock_unit_name, String discountpercent, int qty, double totalprice) {
        this.id = id;
        this.product_id = product_id;
        this.type = type;
        this.measurement = measurement;
