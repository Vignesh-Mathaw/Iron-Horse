...
//                    }
                    ...
                    if (session.getCoordinates(Session.KEY_LATITUDE_MANAGE_ADDRESS).equals("0") || session.getCoordinates(Session.KEY_LONGITUDE_MANAGE_ADDRESS).equals("0")) {
                        longitude = location.getLongitude();
                        latitude = location.getLatitude();
                    } else {
    ...
    public void saveLocation(double latitude, double longitude) {
        session.setData(Session.KEY_LATITUDE_MANAGE_ADDRESS, String.valueOf(latitude));
        session.setData(Session.KEY_LONGITUDE_MANAGE_ADDRESS, String.valueOf(longitude));
    }
